                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="{{ url('public') }}/assets/images/demos/demo-19/products/product-12.jpg" data-zoom-image="{{ url('public') }}/assets/images/demos/demo-19/products/product-12-big.jpg" alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        <label>Berat:</label>
                                        <p>{{number_format ($produk->berat)}} gr</p>
